#!/usr/bin/env python3
"""Helper script to write the demo.py file."""

import os

DEMO_CODE = r'''#!/usr/bin/env python3
...
OUT = r"C:\Users\taidu\.openclaw\workspace\cafe-sim\demo.py"
with open(OUT, "w", encoding="utf-8") as f:
    f.write(DEMO_CODE)
print(f"Wrote {len(DEMO_CODE)} bytes to demo.py")
